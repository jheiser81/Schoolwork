...
namespace BattleSHipDemo
{
    public partial class Form1 : Form
    {
        ...
        private int HumanShots = 0;
        private int CompShots = 0;
        private int PlayerHitCount = 0;
        private int ComputerHitCount = 0;
        private HashSet<int> PlayerLocations = new HashSet<int>(); //need to research this
        private HashSet<int> ComputerLocations = new HashSet<int>();
        private List<int> CompLoacations = new List<int>();//need to research this
