    ...
    public class PlaylistsController : Controller
    {
        ...
        public async Task<IActionResult> Details(int? id)
        {
            ...
            var playlists = await _context.Playlists
                .Include(p => p.PlaylistSongs) //previous code didn't include this
                .ThenInclude(ps => ps.Song)// or this, so the view couldn't access the song title
        ...
        public IActionResult CreatePlaylistForm()
        {
            return PartialView("_CreatePlaylistPartial");
        }
        ...
        public async Task<IActionResult> DeleteConfirmed(int id)
        {
            ...
            // remove all PlaylistSongs associated with this playlist
            foreach (var ps in playlists.PlaylistSongs.ToList())
            {
